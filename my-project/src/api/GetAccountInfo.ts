...
const GetInfoAccount = async (
  search = owner,
): Promise<{ status: boolean; data: ConnexionType | error }> => {
  const res = await fetch(url + `${search}`, { headers: header, mode: "cors" });
  const user = await res.json();
  return { status: res.ok, data: user.data };
};

export const GetInfoFollowers = async (
  search = owner,
): Promise<{ status: boolean; data: Follower[] } | error> => {
...
export const GetInfoRepos = async (
  search = owner,
): Promise<{ status: boolean; data: ReposType[] } | error> => {
...
export const GetInfoOrga = async (
  search = owner,
): Promise<{ status: boolean; data: Organisation[] } | error> => {
...
export const GetInfoFollowings = async (
  search = owner,
): Promise<{ status: boolean; data: Following[] } | error> => {
...
export const GetInfoReposLiked = async (
  search = owner,
): Promise<{ status: boolean; data: ReposType[] } | error> => {
...
export const GetUserEvents = async (
  search = owner,
): Promise<{ status: boolean; data: UserEvents[] } | error> => {
...
export const GetUserReceivedEvents = async (
  search = owner,
): Promise<{ status: boolean; data: UserEvents[] } | error> => {
...
export const GetSocials = async (search = owner): Promise<SocialsList> => {
  const res = await fetch(url + `${search}/socials`, {
    headers: header,
    mode: "cors",
  });
  const rateLimit = await res.json();
