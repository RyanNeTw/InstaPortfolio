                ...
                (
                   <>
                        ...
                        <div className="relative w-full">
                            ...
                            <input type="text" id="simple-search" className="bg-black border border-white text-white text-sm rounded-lg focus:black block w-full pl-10 p-2.5" placeholder="Search" required onChange={handleChange} onKeyDown={handleKeyDown} />
                        </div>
