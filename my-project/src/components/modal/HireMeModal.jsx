          ...
          <div className="flex flex-col">
            <div className="flex flex-row gap-4 items-center justify-center">
              <div className="flex flex-wrap gap-2">
                ...
                <Link
                  to="/profil"
                  className="font-bold text-white underline hover:text-yellow-400 transition"
                >
                  {props.user.login}
                </Link>
              </div>
            ...
            <p className="text-white">
              I{"'"}m looking for a new freelance assignment, so don{"'"}t
              hesitate to contact me.{" "}
            </p>
          </div>
          <h3
            className="pl-4 pr-4 border border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black transition-all rounded cursor-pointer animate-pulse"
            onClick={() => socialsFunction()}
          >
            Hire me
          </h3>
          {openSocials ? (
            <div className="flex flex-row items-center gap-4">
              <a
                href="https://www.linkedin.com/in/ryan-ez-zerqti-964396236/"
              ...
              <a
                href="https://github.com/RyanNeTw"
                className="hover:opacity-70"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <Link
                to="/profil"
                className="hover:opacity-70 border border-1 p-2 rounded-full"
              >
                {" "}
                <AccountSvg />{" "}
              </Link>
