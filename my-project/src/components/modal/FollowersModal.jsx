          ...
          {followers?.length > 0 ? (
            followers.map((follower, index) => {
              return (
                <div
                  key={index}
                  className="flex flex-row justify-between items-center gap-24"
                >
                  <Link
                    to={`/profil/${follower.login}`}
                  ...
                  <a
                    ...
                    className="group relative pl-4 pr-4 rounded border border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black hover:shadow hover:shadow-yellow-400 cursor-pointer"
                    target="_blank"
