  ...
  return (
    <>
      ...
      <div className="flex justify-between flex-col-reverse gap-4 md:gap-4 md:flex-row max-h-screen w-screen md:pl-[10%] md:pr-[10%] ">
            ...
            ? repos.map((repo, index) => {
                ...
                if (index % 4 === 0 && index != 0) {
                  const cvRepo = {
                    ...
                    description:
                      "Bonjour a vous ! C'est mon Cv, il est beau hein ?",
                    stargazers_count: 45,
                  ...
                  return (
                    <div
                      key={index}
                      className=" border border-yellow-400 p-2 hover:scale-105 transition rounded-xl"
                    >
                      <div className="flex flex-col justify-center gap-4">
                        <div className="flex flex-row justify-between items-center">
                          <div className="flex flex-row items-center gap-2">
                            <ProfilPicture
                              ...
                              userEvents={props.userEvents.data}
                              width={"w-8"}
                              height={"w-8"}
                            />
                        ...
                        <div className="flex justify-center">
                          <div
                            className="cursor-pointer w-72 h-72  md:w-96 md:h-96 self-center"
                            onClick={() => closeImageModalFunction(cvRepo)}
                            style={{
                              backgroundImage: `url(${CvRyanEzZerqti2023Image})`,
                        ...
                        <div>
                          <div>
                            <div className="flex flex-row gap-2 items-center">
                              <HeartSvg color={"fill-yellow-500"} />
                ...
                return (
                  <div
                    key={index}
                    className="flex flex-col justify-center gap-4 border border-yellow-400 p-2 hover:scale-105 transition rounded-xl"
                  >
                    <div className="flex flex-row justify-between items-center">
                      <div className="flex flex-row items-center gap-2">
                        <ProfilPicture
                    ...
                    {!repo.topics[0] ? (
                      <div
                        className="w-72 h-72 md:w-96 md:h-96 bg-zinc-800 cursor-pointe self-center"
                        onClick={() => closeImageModalFunction(repo)}
                      ></div>
                    ) : (
                      <div
                        className="cursor-pointer w-72 h-72  md:w-96 md:h-96 self-center"
        ...
        <Suggestions
          user={props.user.data}
          followings={props.followings.data}
          userEvents={props.userEvents.data}
        />
      </div>
