                ...
                { repos && repos?.length > 0 ?
                    repos.map((repo, index) => {
                        ...
                        if((index) % 4 === 0 && index != 0) {
                            ...
                            return(
                                <div key={index} className="shadow-sm shadow-yellow-400 p-2 hover:shadow-md hover:shadow-yellow-400 rounded-xl">
                                    <div className="flex flex-col justify-center gap-4">
                                        ...
                                        <div className='flex justify-center'>
                                            <div className='cursor-pointer w-72 h-72  md:w-96 md:h-96 self-center' onClick={() => closeImageModalFunction(cvRepo)} style={{ backgroundImage: `url(${CvRyanEzZerqti2023Image})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                                        </div>
                                        <div>
                                            <div>
                        ...
                        return(
                            <div key={index} className="flex flex-col justify-center gap-4 shadow-sm shadow-yellow-400 p-2 hover:shadow-md hover:shadow-yellow-400 rounded-xl">
                                <div className='flex flex-row justify-between items-center'>
                                    <div className='flex flex-row items-center gap-2'>
                                        <ProfilPicture user={props.user.data} userEvents={props.userEvents.data} width={'w-8'} height={'w-8'} />
                                        <h3 className='text-white font-bold'>{repo.owner.login}</h3>
