    ...
    <>
      ...
      {props.userEvents ? (
        <img
          ...
          className={`rounded-full border-2 border-yellow-400 cursor-pointer  ${props.width} ${props.height} `}
        ...
        <img
          src={props.user?.avatar_url}
          alt={props.user?.avatar_url}
          className={`rounded-full ${props.width} ${props.height} border-2 border-white`}
        />
      )}
    </>
  );
