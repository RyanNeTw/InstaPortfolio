...
function Form() {
    ...
    return(
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-full flex flex-col gap-2 justify-center items-center rounded-3xl">
            {
                status == '200' ? (
                    <div className="flex flex-row gap-2 items-center">
                        <CheckSvg />
                        <h3 className="text-xs font-bold uppercase tracking-wide text-white">E-mail sent with success</h3>
                    </div>
                ) : null
            }
                <div className="flex flex-col gap-4 md:flex-row justify-between w-full">
                    <div className="flex flex-col w-full md:w-2/4">
                        <h3 className="text-xs font-bold uppercase tracking-wide mb-2 text-white">Email</h3>
                    ...
                    <div className="flex flex-col w-full md:w-2/4">
                        <h3 className="text-xs font-bold uppercase tracking-wide mb-2 text-white">Subject</h3>
                        <input placeholder="Subject" {...register("subject", { required: true })} className="appearance-none block w-full bg-gray-200 text-gray-700 border border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white"/>
                ...
                <div className="flex flex-col w-full">
                        <h3 className="text-xs font-bold uppercase tracking-wide mb-2 text-white">Object</h3>
