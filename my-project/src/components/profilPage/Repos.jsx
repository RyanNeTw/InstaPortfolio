            ...
            {repos && repos?.length > 0
              ? repos.map((repo, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="m-4 inline-block max-w-64 p-4 rounded-2xl flex flex-col gap-2 hover:scale-105 border border-yellow-400 transition"
                    >
                      ...
                      {!repo.topics[0] ? (
                        <div
                          className="w-72 h-64 bg-zinc-800 flex justify-center items-center"
