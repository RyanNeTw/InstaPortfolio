...
function App() {
  ...
  if (!user || !user.status) {
    return <Loader user={user} repos={repos} />;
  }
      ...
      <StoreProvider>
        <BrowserRouter>
          <Routes>
            <Route
              ...
              element={
                <ProfilPage
                  ...
                  reposLiked={reposLiked}
                  userEvents={userEvents}
                  userReceivedEvents={userReceivedEvents}
                />
              }
            ></Route>
            <Route
            ...
            <Route
              path="/cv"
              element={<Curiculum userReceivedEvents={userReceivedEvents} />}
            ></Route>
            <Route
              path="/experience"
              element={<Experience userReceivedEvents={userReceivedEvents} />}
            ></Route>
